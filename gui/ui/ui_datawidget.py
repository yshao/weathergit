...
class Ui_datawidget(object):
    def setupUi(self, datawidget):
        ...
        self.gridLayout.addWidget(self.outSql, 5, 0, 1, 4)
        self.inDownload = QtGui.QPushButton(datawidget)
        self.inDownload.setObjectName(_fromUtf8("inDownload"))
        self.gridLayout.addWidget(self.inDownload, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.inExportType, 6, 0, 1, 2)
    ...
    def retranslateUi(self, datawidget):
        ...
        self.label_2.setText(_translate("datawidget", "SQL", None))
        self.inDownload.setText(_translate("datawidget", "Download", None))
        self.inExportType.setItemText(0, _translate("datawidget", "xlsx", None))
