...
class SchedulerWidget(QtGui.QWidget):
    ...
    def __init__(self, parent = None):
        ...
        self.ui.actionAddEvent.clicked.connect(lambda: self.addEvent())
        self.ui.actionRemoveEvent.clicked.connect(lambda: self.removeEvent())
    ...
    def removeEvent(self):
        ""
        self.ui.eventView.selectedIndexes()

    def addEvent(self):
        ""
        self.eventView.gen_new()
