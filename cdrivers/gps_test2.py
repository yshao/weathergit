...
from twisted.protocols.gps.nmea import InvalidSentence
import sys
...
class GPSOptions(usage.Options):
    ...
    optParameters = [
        ...
        ['port', 'p', '/dev/ttyO1', 'Serial Port device'],
    ]
...
if __name__ == '__main__':
    ...
    try:
        ...
        s = SerialPort(GPSTest(), port, reactor, baudrate=baudrate)
        reactor.run()
